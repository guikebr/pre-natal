...
class CALENDRIO extends StatelessWidget {
  CALENDRIO({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 219.0, end: 43.0),
            child: Scrollbar(
              child: SingleChildScrollView(
                child: Text(
                  'Legenda: M/E= 1ª consulta médica até 10º dia de vida e 2º consulta enfermagem no 30ª dia; \n\nM= consulta médica ; E=consulta com enfermagem\n\nA equipe deverá acolher a criança sempre que\napresentar intercorrência e necessitar de atendimento independentemente do calendário previsto de puericultura e vacinação.',
                  style: TextStyle(
                    fontFamily: 'Adobe Hebrew',
                    fontSize: 15,
          ...
          Pinned.fromPins(
            Pin(start: 27.0, end: 30.0),
            Pin(size: 150.0, middle: 0.4306),
            child: Container(
