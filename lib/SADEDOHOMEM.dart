...
import 'CONCEITOPRNATAL.dart';
import 'package:adobe_xd/page_link.dart';
import 'AGENDAPRNATAL.dart';
import 'EXAMESPRNATAL.dart';
import 'CALENDARIODEVACINAO.dart';
import 'HIGIENEDOPNIS.dart';
import 'CNCERDEPROSTATA.dart';
import 'MTODOPREVENTIVO.dart';
import 'INFECOESSEXUAIS.dart';
import 'LICENAPARTERNIDADE.dart';
import 'TEMAS.dart';
import 'FOTOGESTAO.dart';
import 'package:flutter_svg/flutter_svg.dart';

class SADEDOHOMEM extends StatelessWidget {
  SADEDOHOMEM({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => CALENDARIODEVACINAO(),
                ),
              ],
              child: Text.rich(
                TextSpan(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => LICENAPARTERNIDADE(),
                ),
              ],
              child: Text.rich(
                TextSpan(
