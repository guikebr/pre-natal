...
import 'LEIACOMPANHANTE.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TEMASSADEDAGESTANTE1 extends StatelessWidget {
  TEMASSADEDAGESTANTE1({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'pregnancy-6337608_1…' (shape)
                Container(
