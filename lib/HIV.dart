      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 388.0, end: 56.0),
            child: Scrollbar(
              child: SingleChildScrollView(
                child: Text(
                  'Vírus transmitido sexualmente, por\ncompartilhamento de seringas e agulhas, por transfusão de sangue ou da mãe para o bebê, e que ataca o sistema imunológicohumano, responsável pela defesa do organismo frente a doenças, podendo ocasionar a síndrome da imunodeficiência adquirida (aids). A melhor forma de prevenir a infecção pelo HIV é usando preservativo em todas as relações sexuais. Outras formas biomédicas de se prevenir a infecção pelo HIV são a utilização da profilaxia pós-exposição (PEP), da\nprofilaxia pré-exposição (PrEP) e do tratamento como prevenção (TasP), além do incentivo a intervenções comportamentais\ne estruturais.',
                  style: TextStyle(
