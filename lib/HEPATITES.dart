      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 394.0, end: 49.0),
            child: Scrollbar(
              child: SingleChildScrollView(
                child: Text(
                  'Doenças infecciosas que prejudicam o \nfígado e podem levar à cirrose e ao câncer. \nAs hepatites  virais são classificadas pelas \nletras  A, B, C, D, E, sendo as hepatites B  e \nC mais prevalentes na população  \nmasculina. São preveníveis por  meio de \nações, como: o uso de  preservativos; o não \ncompartilhamento de objetos pessoais (como escovas de dentes)  e de perfurocortantes (seringas, agulhas, lâminas de barbear e kits para manicure, por exemplo). Boas práticas de higiene pessoal são importantes para se evitar a \ninfecção de alguns tipos de hepatites virais, como A e E. Outra forma de prevenção é a vacinação contra as hepatites.\n',
                  style: TextStyle(
