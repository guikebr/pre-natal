...
class Aos11MesesVida extends StatelessWidget {
  const Aos11MesesVida({Key? key}) : super(key: key);
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 61.0, start: 36.0),
            child: const Text(
              'ENTRE 9 E 11 MESES DE VIDA',
              style: TextStyle(
                fontFamily: 'Adobe Hebrew',
                fontSize: 15,
                color: Color(0xff000000),
