...
class ReferenciaParte1 extends StatelessWidget {
  const ReferenciaParte1({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 201.5, end: -127.0),
            Pin(size: 182.1, start: 0.0),
            child: SvgPicture.string(
              _svg_yusaxa,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
...
const String _svg_yusaxa =
    '<svg viewBox="285.5 0.0 201.5 182.1" ><path transform="translate(285.5, 0.0)" d="M 100.748291015625 0 C 156.3900146484375 0 201.49658203125 40.76937866210938 201.49658203125 91.06095123291016 C 201.49658203125 141.3525238037109 156.3900146484375 182.1219024658203 100.748291015625 182.1219024658203 C 45.10655212402344 182.1219024658203 0 141.3525238037109 0 91.06095123291016 C 0 40.76937866210938 45.10655212402344 0 100.748291015625 0 Z" fill="#4842a8" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
