            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => const CamisinhaMasculina(),
                ),
              ],
              child: const Text.rich(
                TextSpan(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => const CirurgiaVasectomia(),
                ),
              ],
              child: const Text.rich(
                TextSpan(
