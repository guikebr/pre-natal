...
import 'SINAISSINTOMAS.dart';
import 'PREVENO.dart';
import 'SADEDOHOMEM.dart';
import 'TEMAS.dart';
import 'package:flutter_svg/flutter_svg.dart';

class CNCERDEPROSTATA extends StatelessWidget {
  CNCERDEPROSTATA({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 233.0, end: 5.0),
            Pin(size: 34.0, start: 95.0),
            child: Text.rich(
              TextSpan(
                style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(size: 94.0, start: 9.0),
            Pin(size: 16.0, middle: 0.516),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
