...
class CONCEITOPRNATAL extends StatelessWidget {
  CONCEITOPRNATAL({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: Text.rich(
              TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text:
                        'O Pré-Natal do Parceiro envolve o homem \nem todo o processo de planejamento \nreprodutivo, gestação, parto, puerpério e \ndesenvolvimento da criança, integrando-o \nnos cuidados com a saúde, para que \ndivida com a mãe a responsabilidade \npelos cuidados com o filho. Dessa forma, \no pai passa a ter também um acesso \nmelhor para cuidar da própria saúde.',
                  ),
                ],
              ),
              textHeightBehavior:
...
const String _svg_xzita =
    '<svg viewBox="14.0 604.0 68.0 24.3" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(14.0, 604.0)" d="M 13.77215194702148 0 L 54.22784805297852 0 C 61.8339958190918 0 68 5.436184883117676 68 12.14205932617188 C 68 18.84793472290039 61.8339958190918 24.28411865234375 54.22784805297852 24.28411865234375 L 13.77215194702148 24.28411865234375 C 6.16600227355957 24.28411865234375 0 18.84793472290039 0 12.14205932617188 C 0 5.436184883117676 6.16600227355957 0 13.77215194702148 0 Z" fill="#4842a8" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
const String _svg_pv7x6 =
    '<svg viewBox="273.0 604.0 68.0 24.3" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(273.0, 604.0)" d="M 13.77215194702148 0 L 54.22784805297852 0 C 61.8339958190918 0 68 5.436184883117676 68 12.14205932617188 C 68 18.84793472290039 61.8339958190918 24.28411865234375 54.22784805297852 24.28411865234375 L 13.77215194702148 24.28411865234375 C 6.16600227355957 24.28411865234375 0 18.84793472290039 0 12.14205932617188 C 0 5.436184883117676 6.16600227355957 0 13.77215194702148 0 Z" fill="#4842a8" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
