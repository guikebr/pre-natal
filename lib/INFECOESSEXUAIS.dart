...
class INFECOESSEXUAIS extends StatelessWidget {
  INFECOESSEXUAIS({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 31.0, start: 9.0),
            Pin(size: 15.0, middle: 0.5824),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
